...
class MarkdownExporter(BaseReportExporter):
    ...
    def __init__(self):
        ...
        try:
            ...
            raise FileNotFoundError("report.md.j2 missing")
    ...
    def export(
        ...
        try:
            ...
            self.logger.error(f"Markdown rendering failed: {e}")
            raise
...
class PDFExporter(MarkdownExporter):
    ...
    def export(
        ...
        try:
            ...
            raise ImportError("PDF export requires: pip install weasyprint markdown2") from e
        ...
        stylesheet_path = Path(__file__).parent / 'styles' / 'report.css'
        stylesheets = [str(stylesheet_path)] if stylesheet_path.exists() else []
        ...
        if output_path:
            ...
            return html_doc.write_pdf(font_config=font_config, stylesheets=stylesheets)
